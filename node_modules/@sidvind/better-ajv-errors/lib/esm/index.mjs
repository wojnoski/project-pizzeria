...
var AdditionalPropValidationError = class extends BaseValidationError {
  ...
  print() {
    ...
    return output.concat(this.getCodeFrame(chalk2`😲  {magentaBright ${params.additionalProperty}} is not expected to be here!`, `${this.instancePath}/${params.additionalProperty}`));
  }
  getError() {
...
var EnumValidationError = class extends BaseValidationError {
  print() {
    ...
    return output.concat(this.getCodeFrame(bestMatch !== null ? chalk3`👈🏽  Did you mean {magentaBright ${bestMatch}} here?` : chalk3`👈🏽  Unexpected value, should be equal to one of the allowed values`));
  }
  getError() {
    const { message, params } = this.options;
    const bestMatch = this.findBestMatch();
...
var DefaultValidationError = class extends BaseValidationError {
  print() {
    ...
    return output.concat(this.getCodeFrame(chalk4`👈🏽  {magentaBright ${keyword}} ${message}`));
  }
  getError() {
    const { keyword, message } = this.options;
    return __spreadProps(__spreadValues({}, this.getLocation()), {
